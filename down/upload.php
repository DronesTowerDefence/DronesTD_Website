...
//
$target_dir = "https://www.client.DronesTD.de/";
...
if ($uploadOk == 0) {
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["name"], $target_file)) {
    echo "Die Datei" . htmlspecialchars(basename($_FILES["fileToUpload"]["tmpname"])) . " wurde hochgeladen. <br><br> Hier gehts zum Profil zurück: 
